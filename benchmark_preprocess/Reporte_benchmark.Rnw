...
\usepackage{authblk,amssymb,amsthm,amsmath,lipsum}
\usepackage{fancyhdr}
...
<<raw_red_boxplot, echo=FALSE, dev='tikz', fig.height = 4, fig.cap = "Boxplot por muestra de logaritmo de la intensidad lumínica del canal rojo">>=
raw_red_boxplot
@

<<raw_green_boxplot, echo=FALSE, dev='tikz', fig.height = 4, fig.cap = "Boxplot de logaritmo de la intensidad lumínica del canal verde por muestra">>=
raw_green_boxplot
@
